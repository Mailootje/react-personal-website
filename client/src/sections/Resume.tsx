...
export function Resume() {
  return (
    <VideoBackground opacity={0.2} className="bg-black">
              ...
              >
                {experiences.map((experience, index) => (
                  <motion.div 
                    ...
                    className="relative pl-8 pb-8 border-l-2 border-gray-600 last:border-0"
                    variants={{
                  ...
                  >
                    ...
                    <div className="bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-700">
                      ...
                      <h5 className="text-gray-400 mb-4">{experience.company}</h5>
              ...
              >
                {educations.map((education) => (
                  <motion.div 
                    ...
                    className="relative pl-8 pb-8 border-l-2 border-gray-600"
                    variants={{
                      hidden: { opacity: 0, y: 20 },
                      visible: { 
                        opacity: 1, 
                  ...
                  >
                    ...
                    <div className="bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-700">
                      ...
                      <h5 className="text-gray-400 mb-4">{education.institution}</h5>
                      <p className="text-sm text-gray-400">
