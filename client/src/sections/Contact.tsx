  ...
  return (
    <section id="contact" className="py-20 px-6 bg-black">
      <Container maxWidth="5xl">
        <SectionHeading subtitle="Get In Touch" title="Contact Me" isDark={true} />
        ...
        <div className="grid md:grid-cols-5 gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-700 mb-6">
          ...
          >
            <div className="bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-700">
              <h4 className="font-bold text-lg mb-6 text-white">Send a Message</h4>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <Textarea 
                    ...
                    onChange={handleChange}
                    className="w-full resize-none bg-gray-800 border-gray-700 text-white"
                  />
                </div>
